            ...
            <Panel>
                ...
                <Panel.Body>
                    <Form horizontal onSubmit={this.handleSubmit}>
                        ...
                        <FormGroup>
                            <Col componentClass={ControlLabel} sm={3}>Statue:</Col>
                            <Col sm={9}>
                        ...
                        >
                            ...
                            <Col sm={9}>
                                <FormControl componentClass={DateInput} name="due" value={due} onChange={this.onChange} onValidityChange={this.onValidityChange} key={id} />
                        ...
                        <FormGroup>
                            ...
                            <Col sm={9}>
                                <FormControl componentClass={TextInput} tag="textarea" rows={8} cols={50} name="description" value={description} onChange={this.onChange} key={id} />
                            </Col>
                        </FormGroup>
                        <FormGroup>
                            <Col smOffset={3} sm={6} />
